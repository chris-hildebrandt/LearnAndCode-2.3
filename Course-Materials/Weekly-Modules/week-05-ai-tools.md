...
6. Test AI-generated code on your `week-05-ai-test` branch.
      Prompting Tip: Don't just type "Fix this." Use the techniques from the reading!
      - Role: "Act as a Senior .NET Developer..."
      - Context: "We are refactoring a legacy controller..."
      - Constraint: "Follow the Stepdown Rule and keep methods under 15 lines."
7. Switch back to `week-05-submission` branch:
   ```bash
   git checkout week-05-submission
   ```

**Check your branch!** Before running the next command, ensure you have committed your changes on `week-05-ai-test` before switching branches, or you will lose your work.

8. Copy your completed `Week-05-AI-Assignment.md` from the AI test branch. *This command tells git: "Go to the week-05-ai-test branch, grab this specific file, and copy it into my current directory."*
   ```bash
