...
- Understand the principles of systems and system organization for modularity and maintainability.
...
1. Create branch `week-08-submission`.

2. **Study Example Implementation (10 min)**
...
3. **Implement GetByIdAsync (15 min)**
...
4. **Implement CreateAsync (15 min)**
...
5. **Implement UpdateAsync (20 min)**
...
6. **Implement DeleteAsync (15 min)**
...
7. **Optional:** Add `cancellationToken.ThrowIfCancellationRequested()` at method start for long operations.
...
- Run `dotnet ef database update` followed by manual `GET` via Swagger to ensure repository works.
- Note: Will still hit `NotImplementedException` in service until Week 9, that's expected.

### Testing Your Repository Without Running the Full App
...
**Expected:** All tests PASS ✅ - if any fail, your repository has a bug!
...
- Week 8 checkbox ticked in `WEEKLY_PROGRESS.md`.
...
- 45 min — Reading and planning queries.
- 65 min — Implementing methods and guard clauses.
...
- **[EF Core In-Memory Testing](https://docs.microsoft.com/en-us/ef/core/testing/testing-with-the-in-memory-database)** - Official guide for testing repositories.

### External Resources

- **[Microsoft Docs: Repository Pattern](https://docs.microsoft.com/en-us/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/infrastructure-persistence-layer-design)** — Official guidance with EF Core examples.
- **[Martin Fowler: Repository Pattern](https://martinfowler.com/eaaCatalog/repository.html)** — Conceptual background.
- **[Refactoring Guru: Repository Pattern](https://refactoring.guru/design-patterns/repository)** — Alternative explanations and diagrams.

### Optional Deep Dives

- **Pro .NET Design Patterns** (Repository chapter) — Advanced nuances for repository implementation.