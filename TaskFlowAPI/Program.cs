...
// TODO Week 14 (ISP): Register segregated interfaces.
// Goal: allow consumers to depend on *only* reads or *only* writes.
//
// Guidance (don’t copy/paste blindly; understand it):
// - Register the concrete TaskRepository once per request (scoped).
// - Register ITaskReader and ITaskWriter to resolve to the same underlying TaskRepository instance.
// - Keep ITaskRepository registration for backwards compatibility during the migration week.
